    ...
    <div id="carousel" class="carousel slide carousel-fade" data-ride="carousel" data-interval="6000">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <a href="#">
                     <picture>
                      <source srcset="/Payroll/img/1.jpg" media="(min-width: 1400px)">
            ...
            <div class="carousel-item">
                <a href="#">
                     <picture>
                      <source srcset="/Payroll/img/2.jpg" media="(min-width: 1400px)">
            ...
            <div class="carousel-item">
                <a href="#">
                     <picture>
                      <source srcset="/Payroll/img/3.jpg" media="(min-width: 1400px)">
